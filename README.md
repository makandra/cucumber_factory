...
- Shorthand:
  ```sh
  for version in "2.5.3" "2.6.6" "2.7.2" "3.2.0" "3.4.1" "4.0.2"; do rbenv shell $version && bundle install && bundle exec rake matrix:install && bundle exec rake matrix:spec; done
  ```
